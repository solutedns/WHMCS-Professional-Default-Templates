...
<div class="btn-group float-right">
	<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#dialog_addRecord" title="{$MLANG.admin_manage_records_addrecord}" {if $maintenance}DISABLED{/if}><span class="fas fa-plus" aria-hidden="true"></span></button>
	...
	<ul class="dropdown-menu dropdown-menu-right" role="menu">
		<li><a class="dropdown-item" href="#" data-toggle="modal" data-target="#dialog_srvAssist">{$MLANG.admin_manage_records_addsrv}</a></li>
		<li><a class="dropdown-item" href="#" data-toggle="modal" data-target="#dialog_tlsaAssist">{$MLANG.admin_manage_records_addtlsa}</a></li>
	</ul>
</div>
...
<div class="table-container clearfix">
	...
	<a class="btn btn-sm btn-default {if $maintenance}disabled{/if}" href="#" onclick="deleteSelected();"><span class="far fa-trash-alt" aria-hidden="true"></span><span class="dropmenu_desc"> {$MLANG.client_manage_records_deleteselected}</span></a>
</div>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h5 class="modal-title">{$MLANG.global_head_add_record}</h5>
					</div>
		...
		<div class="modal fade" id="dialog_deleteRecord" tabindex="-1" role="dialog" aria-labelledby="dialog_deleteRecord" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h5 class="modal-title">{$MLANG.global_head_delete_record}</h5>
					</div>
					<div class="modal-body">
		...
		<div class="modal fade" id="dialog_srvAssist" tabindex="-1" role="dialog" aria-labelledby="dialog_srvAssist" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h5 class="modal-title">{$MLANG.admin_manage_records_addsrv}</h5>
					</div>
					<div class="modal-body">
						<div class="row">
							<div class="col-md-4">
		...
		<div class="modal fade" id="dialog_tlsaAssist" tabindex="-1" role="dialog" aria-labelledby="dialog_tlsaAssist" aria-hidden="true">
			<div class="modal-dialog modal-xl">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h5 class="modal-title">{$MLANG.admin_manage_records_addtlsa}</h5>
					</div>
					<div class="modal-body">
						<div class="row">
							<div class="col-md-6">
