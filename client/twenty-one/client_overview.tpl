{if $client_zones}
	<span data-toggle="modal" data-target="#dialog_addZone" class="float-right">
		<button type="button" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="bottom" title="{$MLANG.global_head_add_zone}" {if $maintenance}DISABLED{/if}><span class="fas fa-plus" aria-hidden="true"></span></button>
	</span>
{/if}
			...
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h5 class="modal-title">{$MLANG.global_head_add_zone}</h5>
					</div>
