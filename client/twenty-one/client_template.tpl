<span data-toggle="modal" data-target="#dialog_addRecord" class="float-right">
	<button type="button" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="bottom" title="{$MLANG.admin_manage_records_addrecord}" {if $maintenance}DISABLED{/if}><span class="fas fa-plus" aria-hidden="true"></span></button>
</span>
